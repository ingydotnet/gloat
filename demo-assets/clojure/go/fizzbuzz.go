...
func LoadNS() {
	...
	// -main
	{
		tmp0 := sym__DASH_main.WithMeta(lang.NewMap(kw_file, "main/core.glj", kw_line, int(5), kw_column, int(7), kw_end_DASH_line, int(5), kw_end_DASH_column, int(11), kw_arglists, lang.NewList(lang.NewVector(sym__AMP_, sym_args)), kw_ns, lang.FindOrCreateNamespace(sym_main_DOT_core))).(*lang.Symbol)
				...
				{ // let
					...
					{ // let
						...
						tmp15 = lang.NewFnFunc(func(args ...any) any {
							...
							tmp19 := checkDerefVar(var_clojure_DOT_core_mod)
							tmp20 := lang.Apply(tmp19, []any{v16, int64(15)})
							tmp21 := lang.Apply(tmp18, []any{tmp20})
							if lang.IsTruthy(tmp21) {
								tmp17 = "FizzBuzz"
							} else {
								var tmp22 any
								tmp23 := checkDerefVar(var_clojure_DOT_core_zero_QMARK_)
								tmp24 := checkDerefVar(var_clojure_DOT_core_mod)
								tmp25 := lang.Apply(tmp24, []any{v16, int64(5)})
								tmp26 := lang.Apply(tmp23, []any{tmp25})
								if lang.IsTruthy(tmp26) {
									tmp22 = "Buzz"
								} else {
									var tmp27 any
									tmp28 := checkDerefVar(var_clojure_DOT_core_zero_QMARK_)
									tmp29 := checkDerefVar(var_clojure_DOT_core_mod)
									tmp30 := lang.Apply(tmp29, []any{v16, int64(3)})
						...
						tmp16 := lang.NewMap(kw_file, "main/core.glj", kw_line, int(9), kw_column, int(20), kw_end_DASH_line, int(12), kw_end_DASH_column, int(42))
						...
						tmp21 := lang.Apply(tmp18, []any{int64(1), tmp20})
						tmp22 := lang.Apply(tmp14, []any{tmp17, tmp21})
						tmp23 := lang.Apply(tmp13, []any{tmp22})
						var v24 any = tmp23
						_ = v24
						// let binding "chunk_2"
						var v25 any = nil
						...
						for {
							var tmp28 any
							tmp29 := checkDerefVar(var_clojure_DOT_core__LT_)
							tmp30 := lang.Apply(tmp29, []any{v27, v26})
							if lang.IsTruthy(tmp30) {
								var tmp31 any
								{ // let
									// let binding "x"
									tmp32, _ := lang.FieldOrMethod(v25, "nth")
									...
									var v34 any = tmp33
									_ = v34
									tmp35 := checkDerefVar(var_clojure_DOT_core_println)
									tmp36 := lang.Apply(tmp35, []any{v34})
									_ = tmp36
									var tmp37 any = v24
									var tmp38 any = v25
									var tmp39 any = v26
									tmp41 := checkDerefVar(var_clojure_DOT_core_unchecked_DASH_inc)
									tmp42 := lang.Apply(tmp41, []any{v27})
									var tmp40 any = tmp42
									v24 = tmp37
									v25 = tmp38
									v26 = tmp39
										...
										{ // let
											...
											if lang.IsTruthy(tmp41) {
												...
												{ // let
													...
													var v45 any = tmp44
													_ = v45
													tmp47 := checkDerefVar(var_clojure_DOT_core_chunk_DASH_rest)
													tmp48 := lang.Apply(tmp47, []any{v38})
													var tmp46 any = tmp48
													var tmp49 any = v45
													tmp51 := checkDerefVar(var_clojure_DOT_core_int)
													tmp52 := checkDerefVar(var_clojure_DOT_core_count)
													tmp53 := lang.Apply(tmp52, []any{v45})
												...
												{ // let
													...
													var v46 any = tmp45
													_ = v46
													tmp47 := checkDerefVar(var_clojure_DOT_core_println)
													tmp48 := lang.Apply(tmp47, []any{v46})
													_ = tmp48
													tmp50 := checkDerefVar(var_clojure_DOT_core_next)
