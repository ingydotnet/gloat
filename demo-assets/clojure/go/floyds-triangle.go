...
func LoadNS() {
	...
	sym_triangle_DASH_list := lang.NewSymbol("triangle-list")
	sym_triangle_DASH_print := lang.NewSymbol("triangle-print")
	...
	// var main.core/triangle-list
	var_main_DOT_core_triangle_DASH_list := lang.InternVarName(sym_main_DOT_core, sym_triangle_DASH_list)
	// var main.core/triangle-print
	var_main_DOT_core_triangle_DASH_print := lang.InternVarName(sym_main_DOT_core, sym_triangle_DASH_print)
	...
	// -main
	{
		tmp0 := sym__DASH_main.WithMeta(lang.NewMap(kw_file, "main/core.glj", kw_line, int(25), kw_column, int(7), kw_end_DASH_line, int(25), kw_end_DASH_column, int(11), kw_arglists, lang.NewList(lang.NewVector(sym__AMP_, sym_args)), kw_ns, lang.FindOrCreateNamespace(sym_main_DOT_core))).(*lang.Symbol)
		...
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			...
			default:
				...
				{ // let
					// let binding "n"
					tmp4 := checkDerefVar(var_clojure_DOT_core_parse_DASH_long)
					var tmp5 any
					{ // let
						// let binding "or__0__auto__"
						tmp6 := checkDerefVar(var_clojure_DOT_core_first)
					...
					var v7 any = tmp6
					_ = v7
					tmp8 := checkDerefVar(var_main_DOT_core_triangle_DASH_print)
	...
	// triangle-list
	{
		tmp0 := sym_triangle_DASH_list.WithMeta(lang.NewMap(kw_file, "main/core.glj", kw_line, int(6), kw_column, int(7), kw_end_DASH_line, int(6), kw_end_DASH_column, int(19), kw_arglists, lang.NewList(lang.NewVector(sym_n)), kw_ns, lang.FindOrCreateNamespace(sym_main_DOT_core))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			checkArity(args, 1)
			v2 := args[0]
			...
			{ // let
				...
				tmp6 := checkDerefVar(var_clojure_DOT_core_range)
				...
				{ // let
					...
					tmp14 := lang.NewMap(kw_file, "main/core.glj", kw_line, int(8), kw_column, int(23), kw_end_DASH_line, int(8), kw_end_DASH_column, int(24))
					...
					for {
						...
						tmp21 := lang.Apply(tmp18, []any{v2, tmp20})
						if lang.IsTruthy(tmp21) {
							tmp17 = v16
						} else {
							tmp23 := checkDerefVar(var_clojure_DOT_core_drop)
							tmp24 := lang.Apply(tmp23, []any{v12, v11})
							var tmp22 any = tmp24
							tmp26 := checkDerefVar(var_clojure_DOT_core_inc)
							tmp27 := lang.Apply(tmp26, []any{v12})
							var tmp25 any = tmp27
							tmp29 := checkDerefVar(var_clojure_DOT_core_conj)
							tmp30 := checkDerefVar(var_clojure_DOT_core_take)
							tmp31 := lang.Apply(tmp30, []any{v12, v11})
							tmp32 := lang.Apply(tmp29, []any{v16, tmp31})
							var tmp28 any = tmp32
							v11 = tmp22
							v12 = tmp25
							v16 = tmp28
		...
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var_main_DOT_core_triangle_DASH_list = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_main_DOT_core_triangle_DASH_list.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// triangle-print
	{
		tmp0 := sym_triangle_DASH_print.WithMeta(lang.NewMap(kw_file, "main/core.glj", kw_line, int(13), kw_column, int(7), kw_end_DASH_line, int(13), kw_end_DASH_column, int(20), kw_arglists, lang.NewList(lang.NewVector(sym_n)), kw_ns, lang.FindOrCreateNamespace(sym_main_DOT_core))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			checkArity(args, 1)
			v2 := args[0]
			...
			{ // let
				// let binding "t"
				tmp4 := checkDerefVar(var_main_DOT_core_triangle_DASH_list)
				...
				tmp9 := checkDerefVar(var_clojure_DOT_core_last)
				...
				tmp14 := lang.Apply(tmp7, []any{tmp13})
				var v15 any = tmp14
				_ = v15
				// let binding "f"
				...
				tmp17 = lang.NewFnFunc(func(args ...any) any {
					...
					v18 := args[0]
					_ = v18
					tmp19 := checkDerefVar(var_clojure_DOT_core_map)
					tmp20 := checkDerefVar(var_clojure_DOT_core_str)
					tmp21 := lang.Apply(tmp19, []any{tmp20, v18})
					return tmp21
				})
				tmp18 := lang.NewMap(kw_file, "main/core.glj", kw_line, int(16), kw_column, int(16), kw_end_DASH_line, int(16), kw_end_DASH_column, int(27))
				tmp19, err := lang.WithMeta(tmp17, tmp18.(lang.IPersistentMap))
				if err != nil {
					panic(err)
				}
				tmp20 := lang.Apply(tmp16, []any{tmp19, v6})
				var v21 any = tmp20
				_ = v21
				// let binding "l"
				tmp22 := checkDerefVar(var_clojure_DOT_core_map)
				var tmp23 lang.FnFunc
				tmp23 = lang.NewFnFunc(func(args ...any) any {
					checkArity(args, 1)
					v24 := args[0]
					_ = v24
					tmp25 := checkDerefVar(var_clojure_DOT_core_map)
					...
					tmp26 = lang.NewFnFunc(func(args ...any) any {
						...
						tmp32 := lang.Apply(tmp29, []any{v15, tmp31})
						if lang.IsTruthy(tmp32) {
							...
							tmp36 := checkDerefVar(var_clojure_DOT_core_take)
							tmp37 := checkDerefVar(var_clojure_DOT_core__DASH_)
							tmp38 := checkDerefVar(var_clojure_DOT_core_count)
							tmp39 := lang.Apply(tmp38, []any{v27})
							tmp40 := lang.Apply(tmp37, []any{v15, tmp39})
							tmp41 := checkDerefVar(var_clojure_DOT_core_repeat)
							tmp42 := lang.Apply(tmp41, []any{" "})
							tmp43 := lang.Apply(tmp36, []any{tmp40, tmp42})
							tmp44 := lang.Apply(tmp34, []any{tmp35, tmp43})
							tmp45 := lang.Apply(tmp33, []any{tmp44, v27})
							tmp28 = tmp45
						} else {
							tmp28 = v27
						}
					...
					tmp27 := lang.NewMap(kw_file, "main/core.glj", kw_line, int(17), kw_column, int(22), kw_end_DASH_line, int(20), kw_end_DASH_column, int(34))
				...
				tmp24 := lang.NewMap(kw_file, "main/core.glj", kw_line, int(17), kw_column, int(16), kw_end_DASH_line, int(20), kw_end_DASH_column, int(37))
				tmp25, err := lang.WithMeta(tmp23, tmp24.(lang.IPersistentMap))
				if err != nil {
					panic(err)
				}
				tmp26 := lang.Apply(tmp22, []any{tmp25, v21})
				var v27 any = tmp26
				_ = v27
				// let binding "e"
				...
				tmp29 = lang.NewFnFunc(func(args ...any) any {
					...
					tmp33 := lang.NewMap(kw_file, "main/core.glj", kw_line, int(21), kw_column, int(22), kw_end_DASH_line, int(21), kw_end_DASH_column, int(41))
					tmp34, err := lang.WithMeta(tmp32, tmp33.(lang.IPersistentMap))
					if err != nil {
						panic(err)
					}
					tmp35 := lang.Apply(tmp31, []any{tmp34, v30})
					return tmp35
				})
				tmp30 := lang.NewMap(kw_file, "main/core.glj", kw_line, int(21), kw_column, int(16), kw_end_DASH_line, int(21), kw_end_DASH_column, int(44))
				tmp31, err := lang.WithMeta(tmp29, tmp30.(lang.IPersistentMap))
				if err != nil {
					panic(err)
				}
				tmp32 := lang.Apply(tmp28, []any{tmp31, v27})
				var v33 any = tmp32
				_ = v33
				var tmp34 any
				{ // let
					...
					for {
						var tmp41 any
						tmp42 := checkDerefVar(var_clojure_DOT_core__LT_)
						tmp43 := lang.Apply(tmp42, []any{v40, v39})
						if lang.IsTruthy(tmp43) {
							var tmp44 any
							{ // let
								// let binding "row"
								tmp45, _ := lang.FieldOrMethod(v38, "nth")
								...
								var v47 any = tmp46
								_ = v47
								tmp48 := checkDerefVar(var_clojure_DOT_core_println)
								tmp49 := checkDerefVar(var_clojure_DOT_core_apply)
								tmp50 := checkDerefVar(var_clojure_DOT_core_str)
								tmp51 := lang.Apply(tmp49, []any{tmp50, v47})
								tmp52 := lang.Apply(tmp48, []any{tmp51})
								_ = tmp52
								var tmp53 any = v37
								var tmp54 any = v38
								var tmp55 any = v39
								tmp57 := checkDerefVar(var_clojure_DOT_core_unchecked_DASH_inc)
							...
							{ // let
								...
								tmp47 := lang.Apply(tmp46, []any{v37})
								var v48 any = tmp47
								_ = v48
								var tmp49 any
								if lang.IsTruthy(v48) {
									...
									{ // let
										...
										_ = v51
										var tmp52 any
										tmp53 := checkDerefVar(var_clojure_DOT_core_chunked_DASH_seq_QMARK_)
										tmp54 := lang.Apply(tmp53, []any{v51})
										if lang.IsTruthy(tmp54) {
											var tmp55 any
											{ // let
												// let binding "c__0__auto__"
												tmp56 := checkDerefVar(var_clojure_DOT_core_chunk_DASH_first)
												tmp57 := lang.Apply(tmp56, []any{v51})
												var v58 any = tmp57
												_ = v58
												tmp60 := checkDerefVar(var_clojure_DOT_core_chunk_DASH_rest)
												tmp61 := lang.Apply(tmp60, []any{v51})
												var tmp59 any = tmp61
												var tmp62 any = v58
												tmp64 := checkDerefVar(var_clojure_DOT_core_int)
												tmp65 := checkDerefVar(var_clojure_DOT_core_count)
												tmp66 := lang.Apply(tmp65, []any{v58})
												tmp67 := lang.Apply(tmp64, []any{tmp66})
												var tmp63 any = tmp67
												tmp69 := checkDerefVar(var_clojure_DOT_core_int)
												tmp70 := lang.Apply(tmp69, []any{int64(0)})
												var tmp68 any = tmp70
												v37 = tmp59
												v38 = tmp62
												v39 = tmp63
											...
											{ // let
												// let binding "row"
												tmp57 := checkDerefVar(var_clojure_DOT_core_first)
												tmp58 := lang.Apply(tmp57, []any{v51})
												var v59 any = tmp58
												_ = v59
												tmp60 := checkDerefVar(var_clojure_DOT_core_println)
												tmp61 := checkDerefVar(var_clojure_DOT_core_apply)
												tmp62 := checkDerefVar(var_clojure_DOT_core_str)
												tmp63 := lang.Apply(tmp61, []any{tmp62, v59})
												tmp64 := lang.Apply(tmp60, []any{tmp63})
												_ = tmp64
												tmp66 := checkDerefVar(var_clojure_DOT_core_next)
												tmp67 := lang.Apply(tmp66, []any{v51})
												var tmp65 any = tmp67
												var tmp68 any = nil
		...
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var_main_DOT_core_triangle_DASH_print = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_main_DOT_core_triangle_DASH_print.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
}
