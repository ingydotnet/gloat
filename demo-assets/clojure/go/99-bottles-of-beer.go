...
func LoadNS() {
	...
	sym_lyrics := lang.NewSymbol("lyrics")
	...
	sym_paragraph := lang.NewSymbol("paragraph")
	...
	// var main.core/lyrics
	var_main_DOT_core_lyrics := lang.InternVarName(sym_main_DOT_core, sym_lyrics)
	// var main.core/paragraph
	var_main_DOT_core_paragraph := lang.InternVarName(sym_main_DOT_core, sym_paragraph)
	...
	// -main
	{
		tmp0 := sym__DASH_main.WithMeta(lang.NewMap(kw_file, "main/core.glj", kw_line, int(16), kw_column, int(7), kw_end_DASH_line, int(16), kw_end_DASH_column, int(11), kw_arglists, lang.NewList(lang.NewVector(sym__AMP_, sym_args)), kw_ns, lang.FindOrCreateNamespace(sym_main_DOT_core))).(*lang.Symbol)
		...
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			...
			default:
				...
				{ // let
					...
					var v7 any = tmp6
					_ = v7
					tmp8 := checkDerefVar(var_clojure_DOT_core_println)
					tmp9 := checkDerefVar(var_main_DOT_core_lyrics)
	...
	// lyrics
	{
		tmp0 := sym_lyrics.WithMeta(lang.NewMap(kw_file, "main/core.glj", kw_line, int(11), kw_column, int(7), kw_end_DASH_line, int(11), kw_end_DASH_column, int(12), kw_arglists, lang.NewList(lang.NewVector(sym_num)), kw_ns, lang.FindOrCreateNamespace(sym_main_DOT_core))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			checkArity(args, 1)
			v2 := args[0]
			...
			{ // let
				// let binding "numbers"
				tmp4 := checkDerefVar(var_clojure_DOT_core_range)
				tmp5 := lang.Apply(tmp4, []any{v2, int64(0), int64(-1)})
				var v6 any = tmp5
				_ = v6
				// let binding "paragraphs"
				tmp7 := checkDerefVar(var_clojure_DOT_core_map)
				tmp8 := checkDerefVar(var_main_DOT_core_paragraph)
				tmp9 := lang.Apply(tmp7, []any{tmp8, v6})
				var v10 any = tmp9
				_ = v10
		...
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var_main_DOT_core_lyrics = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_main_DOT_core_lyrics.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// paragraph
	{
		tmp0 := sym_paragraph.WithMeta(lang.NewMap(kw_file, "main/core.glj", kw_line, int(5), kw_column, int(7), kw_end_DASH_line, int(5), kw_end_DASH_column, int(15), kw_arglists, lang.NewList(lang.NewVector(sym_num)), kw_ns, lang.FindOrCreateNamespace(sym_main_DOT_core))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			checkArity(args, 1)
			v2 := args[0]
			...
			tmp4 := checkDerefVar(var_clojure_DOT_core_dec)
			tmp5 := lang.Apply(tmp4, []any{v2})
			tmp6 := lang.Apply(tmp3, []any{v2, " bottles of beer on the wall\n", v2, " bottles of beer\n", "Take one down, pass it around\n", tmp5, " bottles of beer on the wall.\n"})
			return tmp6
		})
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var_main_DOT_core_paragraph = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_main_DOT_core_paragraph.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
}
