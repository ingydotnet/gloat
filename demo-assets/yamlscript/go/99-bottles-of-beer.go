...
func init() {
	runtime.RegisterNSLoader("_99_bottles_of_beer/core", LoadNS)
}
...
// LoadNS initializes the namespace "_99_bottles_of_beer.core"
func LoadNS() {
	...
	sym__99_bottles_of_beer_DOT_core := lang.NewSymbol("_99_bottles_of_beer.core")
	...
	sym_bottles := lang.NewSymbol("bottles")
	...
	sym_number := lang.NewSymbol("number")
	...
	// var _99_bottles_of_beer.core/-main
	var__99_bottles_of_beer_DOT_core__DASH_main := lang.InternVarName(sym__99_bottles_of_beer_DOT_core, sym__DASH_main)
	// var _99_bottles_of_beer.core/bottles
	var__99_bottles_of_beer_DOT_core_bottles := lang.InternVarName(sym__99_bottles_of_beer_DOT_core, sym_bottles)
	// var _99_bottles_of_beer.core/main
	var__99_bottles_of_beer_DOT_core_main := lang.InternVarName(sym__99_bottles_of_beer_DOT_core, sym_main)
	// var clojure.core/<
	...
	_ = reflect.TypeOf
	ns := lang.FindOrCreateNamespace(sym__99_bottles_of_beer_DOT_core)
	_ = ns
	...
	// -main
	{
		tmp0 := sym__DASH_main.WithMeta(lang.NewMap(kw_file, "_99_bottles_of_beer/core.glj", kw_line, int(25), kw_column, int(7), kw_end_DASH_line, int(25), kw_end_DASH_column, int(11), kw_arglists, lang.NewList(lang.NewVector(sym__AMP_, sym_argv)), kw_ns, lang.FindOrCreateNamespace(sym__99_bottles_of_beer_DOT_core))).(*lang.Symbol)
		...
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			...
			default:
				...
				{ // let
					...
					tmp20 := lang.Apply(tmp19, []any{"/home/ingy/src/gloat/demo/yamlscript/99-bottles-of-beer.ys"})
					...
					tmp28 := checkDerefVar(var__99_bottles_of_beer_DOT_core_main)
		...
		var__99_bottles_of_beer_DOT_core__DASH_main = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var__99_bottles_of_beer_DOT_core__DASH_main.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// bottles
	{
		tmp0 := sym_bottles.WithMeta(lang.NewMap(kw_file, "_99_bottles_of_beer/core.glj", kw_line, int(22), kw_column, int(7), kw_end_DASH_line, int(22), kw_end_DASH_column, int(13), kw_arglists, lang.NewList(lang.NewVector(sym_n)), kw_ns, lang.FindOrCreateNamespace(sym__99_bottles_of_beer_DOT_core))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			checkArity(args, 1)
			v2 := args[0]
			...
			var tmp3 any
			{ // let
				// let binding "pred__230"
				tmp4 := checkDerefVar(var_ys_DOT_v0_eq)
				var v5 any = tmp4
				_ = v5
				// let binding "expr__231"
				var v6 any = v2
				_ = v6
				var tmp7 any
				tmp8 := lang.Apply(v5, []any{int64(0), v6})
				if lang.IsTruthy(tmp8) {
					tmp7 = "No more bottles"
				} else {
					var tmp9 any
					tmp10 := lang.Apply(v5, []any{int64(1), v6})
					if lang.IsTruthy(tmp10) {
						tmp9 = "1 bottle"
					} else {
						tmp11 := checkDerefVar(var_clojure_DOT_core_str)
						tmp12 := lang.Apply(tmp11, []any{v2, " bottles"})
						tmp9 = tmp12
					}
					tmp7 = tmp9
				}
		...
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var__99_bottles_of_beer_DOT_core_bottles = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var__99_bottles_of_beer_DOT_core_bottles.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// main
	{
		tmp0 := sym_main.WithMeta(lang.NewMap(kw_file, "_99_bottles_of_beer/core.glj", kw_line, int(7), kw_column, int(7), kw_end_DASH_line, int(7), kw_end_DASH_column, int(10), kw_arglists, lang.NewList(lang.NewVector(sym_number), lang.NewVector()), kw_ns, lang.FindOrCreateNamespace(sym__99_bottles_of_beer_DOT_core))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			switch len(args) {
			case 1:
				v2 := args[0]
				_ = v2
				tmp3 := checkDerefVar(var_clojure_DOT_core_doall)
				var tmp4 any
				{ // let
										...
										{ // let
											...
											if lang.IsTruthy(v14) {
												...
												{ // let
													...
													_ = v17
													var tmp18 any
													tmp19 := checkDerefVar(var_clojure_DOT_core_chunked_DASH_seq_QMARK_)
													tmp20 := lang.Apply(tmp19, []any{v17})
													if lang.IsTruthy(tmp20) {
														var tmp21 any
														{ // let
															// let binding "c__0__auto__"
															tmp22 := checkDerefVar(var_clojure_DOT_core_chunk_DASH_first)
															tmp23 := lang.Apply(tmp22, []any{v17})
															var v24 any = tmp23
															_ = v24
															// let binding "size__1__auto__"
															tmp25 := checkDerefVar(var_clojure_DOT_core_int)
															...
															{ // let
																...
																tmp36 := lang.Apply(tmp35, []any{int64(0)})
																var v37 any = tmp36
																_ = v37
																for {
																	var tmp38 any
																	tmp39 := checkDerefVar(var_clojure_DOT_core__LT_)
																	tmp40 := lang.Apply(tmp39, []any{v37, v29})
																	if lang.IsTruthy(tmp40) {
																		var tmp41 any
																		{ // let
																			// let binding "num"
																			tmp42, _ := lang.FieldOrMethod(v24, "nth")
																			...
																			var v44 any = tmp43
																			_ = v44
																			tmp45 := checkDerefVar(var_clojure_DOT_core_chunk_DASH_append)
																			tmp46 := checkDerefVar(var_ys_DOT_v0_say)
																			tmp47 := checkDerefVar(var_clojure_DOT_core_str)
																			tmp48 := checkDerefVar(var__99_bottles_of_beer_DOT_core_bottles)
																			tmp49 := lang.Apply(tmp48, []any{v44})
																			tmp50 := checkDerefVar(var__99_bottles_of_beer_DOT_core_bottles)
																			tmp51 := lang.Apply(tmp50, []any{v44})
																			tmp52 := checkDerefVar(var__99_bottles_of_beer_DOT_core_bottles)
																			tmp53 := checkDerefVar(var_ys_DOT_v0_dec_PLUS_)
																			tmp54 := lang.Apply(tmp53, []any{v44})
																			tmp55 := lang.Apply(tmp52, []any{tmp54})
																			tmp56 := lang.Apply(tmp47, []any{tmp49, " of beer on the wall,\n", tmp51, " of beer.\nTake one down, pass it around.\n", tmp55, " of beer on the wall.", "\n"})
																			tmp57 := lang.Apply(tmp46, []any{tmp56})
																			tmp58 := lang.Apply(tmp45, []any{v32, tmp57})
																			_ = tmp58
																			tmp60 := checkDerefVar(var_clojure_DOT_core_unchecked_DASH_inc)
																			tmp61 := lang.Apply(tmp60, []any{v37})
																			var tmp59 any = tmp61
																			v37 = tmp59
																			continue
																		} // end let
															...
															if lang.IsTruthy(tmp34) {
																...
																tmp40 := lang.Apply(v6, []any{tmp39})
																tmp41 := lang.Apply(tmp35, []any{tmp37, tmp40})
																tmp33 = tmp41
															} else {
																tmp42 := checkDerefVar(var_clojure_DOT_core_chunk_DASH_cons)
																tmp43 := checkDerefVar(var_clojure_DOT_core_chunk)
																tmp44 := lang.Apply(tmp43, []any{v32})
																tmp45 := lang.Apply(tmp42, []any{tmp44, nil})
																tmp33 = tmp45
															}
															tmp21 = tmp33
														} // end let
														...
														{ // let
															// let binding "num"
															tmp23 := checkDerefVar(var_clojure_DOT_core_first)
															tmp24 := lang.Apply(tmp23, []any{v17})
															var v25 any = tmp24
															_ = v25
															tmp26 := checkDerefVar(var_clojure_DOT_core_cons)
															tmp27 := checkDerefVar(var_ys_DOT_v0_say)
															tmp28 := checkDerefVar(var_clojure_DOT_core_str)
															tmp29 := checkDerefVar(var__99_bottles_of_beer_DOT_core_bottles)
															tmp30 := lang.Apply(tmp29, []any{v25})
															tmp31 := checkDerefVar(var__99_bottles_of_beer_DOT_core_bottles)
															tmp32 := lang.Apply(tmp31, []any{v25})
															tmp33 := checkDerefVar(var__99_bottles_of_beer_DOT_core_bottles)
															tmp34 := checkDerefVar(var_ys_DOT_v0_dec_PLUS_)
															tmp35 := lang.Apply(tmp34, []any{v25})
															tmp36 := lang.Apply(tmp33, []any{tmp35})
															tmp37 := lang.Apply(tmp28, []any{tmp30, " of beer on the wall,\n", tmp32, " of beer.\nTake one down, pass it around.\n", tmp36, " of beer on the wall.", "\n"})
															tmp38 := lang.Apply(tmp27, []any{tmp37})
															tmp39 := checkDerefVar(var_clojure_DOT_core_rest)
															tmp40 := lang.Apply(tmp39, []any{v17})
															tmp41 := lang.Apply(v6, []any{tmp40})
															tmp42 := lang.Apply(tmp26, []any{tmp38, tmp41})
															tmp22 = tmp42
														} // end let
														tmp18 = tmp22
													}
					...
					var v6 any = tmp5
					_ = v6
					tmp7 := checkDerefVar(var_ys_DOT_v0_rng)
					tmp8 := lang.Apply(tmp7, []any{v2, int64(1)})
					tmp9 := lang.Apply(v6, []any{tmp8})
					tmp4 = tmp9
				} // end let
				tmp5 := lang.Apply(tmp3, []any{tmp4})
				return tmp5
			case 0:
				tmp2 := checkDerefVar(var__99_bottles_of_beer_DOT_core_main)
				tmp3 := lang.Apply(tmp2, []any{int64(99)})
				return tmp3
			default:
				checkArity(args, -1)
				panic("unreachable")
		...
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var__99_bottles_of_beer_DOT_core_main = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var__99_bottles_of_beer_DOT_core_main.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
}
