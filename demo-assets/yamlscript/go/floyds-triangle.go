...
func init() {
	runtime.RegisterNSLoader("floyds_triangle/core", LoadNS)
}
...
// LoadNS initializes the namespace "floyds_triangle.core"
func LoadNS() {
	...
	sym_floyds_triangle_DOT_core := lang.NewSymbol("floyds_triangle.core")
	...
	// var floyds_triangle.core/-main
	var_floyds_triangle_DOT_core__DASH_main := lang.InternVarName(sym_floyds_triangle_DOT_core, sym__DASH_main)
	// var floyds_triangle.core/main
	var_floyds_triangle_DOT_core_main := lang.InternVarName(sym_floyds_triangle_DOT_core, sym_main)
	// var ys.v0/+drop
	...
	_ = reflect.TypeOf
	ns := lang.FindOrCreateNamespace(sym_floyds_triangle_DOT_core)
	_ = ns
	...
	// -main
	{
		tmp0 := sym__DASH_main.WithMeta(lang.NewMap(kw_file, "floyds_triangle/core.glj", kw_line, int(26), kw_column, int(7), kw_end_DASH_line, int(26), kw_end_DASH_column, int(11), kw_arglists, lang.NewList(lang.NewVector(sym__AMP_, sym_argv)), kw_ns, lang.FindOrCreateNamespace(sym_floyds_triangle_DOT_core))).(*lang.Symbol)
		...
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			...
			default:
				...
				{ // let
					...
					tmp20 := lang.Apply(tmp19, []any{"/home/ingy/src/gloat/demo/yamlscript/floyds-triangle.ys"})
					...
					tmp28 := checkDerefVar(var_floyds_triangle_DOT_core_main)
		...
		var_floyds_triangle_DOT_core__DASH_main = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_floyds_triangle_DOT_core__DASH_main.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// main
	{
		tmp0 := sym_main.WithMeta(lang.NewMap(kw_file, "floyds_triangle/core.glj", kw_line, int(5), kw_column, int(7), kw_end_DASH_line, int(5), kw_end_DASH_column, int(10), kw_arglists, lang.NewList(lang.NewVector(sym_n), lang.NewVector()), kw_ns, lang.FindOrCreateNamespace(sym_floyds_triangle_DOT_core))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			switch len(args) {
			case 1:
				...
				{ // let
					// let binding "nums"
					tmp4 := checkDerefVar(var_ys_DOT_v0__PLUS_map)
					tmp5 := checkDerefVar(var_clojure_DOT_core_range)
					tmp6 := lang.Apply(tmp5, nil)
					tmp7 := checkDerefVar(var_ys_DOT_v0_mul_PLUS_)
					tmp8 := checkDerefVar(var_clojure_DOT_core_inc)
					tmp9 := checkDerefVar(var_clojure_DOT_core_str)
					tmp10 := lang.Apply(tmp7, []any{tmp8, tmp9})
					tmp11 := lang.Apply(tmp4, []any{tmp6, tmp10})
					var v12 any = tmp11
					_ = v12
					// let binding "rows"
					var tmp13 any
					{ // let
						...
						tmp17 := lang.NewMap(kw_file, "floyds_triangle/core.glj", kw_line, int(12), kw_column, int(28), kw_end_DASH_line, int(12), kw_end_DASH_column, int(29))
						...
						for {
							var tmp20 any
							tmp21 := checkDerefVar(var_clojure_DOT_core__LT_)
							tmp22 := checkDerefVar(var_clojure_DOT_core_count)
							tmp23 := lang.Apply(tmp22, []any{v19})
							tmp24 := lang.Apply(tmp21, []any{tmp23, v2})
							if lang.IsTruthy(tmp24) {
								tmp26 := checkDerefVar(var_ys_DOT_v0_inc_PLUS_)
								tmp27 := lang.Apply(tmp26, []any{v14})
								var tmp25 any = tmp27
								tmp29 := checkDerefVar(var_ys_DOT_v0__PLUS_drop)
								tmp30 := lang.Apply(tmp29, []any{v15, v14})
								var tmp28 any = tmp30
								tmp32 := checkDerefVar(var_clojure_DOT_core_conj)
								tmp33 := checkDerefVar(var_ys_DOT_v0__PLUS_take)
								tmp34 := lang.Apply(tmp33, []any{v15, v14})
								tmp35 := lang.Apply(tmp32, []any{v19, tmp34})
								var tmp31 any = tmp35
								v14 = tmp25
								v15 = tmp28
								v19 = tmp31
					...
					tmp15 = lang.NewFnFunc(func(args ...any) any {
						...
						default:
							...
							{ // let
								...
								var v21 any = tmp20
								_ = v21
								tmp22 := checkDerefVar(var_ys_DOT_v0_add_PLUS_)
								tmp23 := checkDerefVar(var_ys_DOT_v0_mul_PLUS_)
								tmp24 := checkDerefVar(var_ys_DOT_v0_sub_PLUS_)
								tmp25 := checkDerefVar(var_clojure_DOT_core_count)
								tmp26 := checkDerefVar(var_clojure_DOT_core_last)
								tmp27 := checkDerefVar(var_clojure_DOT_core_last)
								...
								tmp33 := lang.Apply(tmp24, []any{tmp30, tmp32})
								tmp34 := lang.Apply(tmp23, []any{" ", tmp33})
								tmp35 := lang.Apply(tmp22, []any{tmp34, v21})
								tmp17 = tmp35
							} // end let
							return tmp17
						}
					})
					tmp16 := lang.NewMap(kw_file, "floyds_triangle/core.glj", kw_line, int(18), kw_column, int(5), kw_end_DASH_line, int(22), kw_end_DASH_column, int(10))
					...
					var v18 any = tmp17
					_ = v18
					tmp19 := checkDerefVar(var_clojure_DOT_core_doall)
					var tmp20 any
					{ // let
						...
						{ // function iter__230
							...
							tmp21 = lang.NewFnFunc(func(args ...any) any {
													...
													{ // let
														...
														if lang.IsTruthy(tmp36) {
															...
															{ // let
																...
																{ // let
																	// let binding "i__232"
																	tmp51 := checkDerefVar(var_clojure_DOT_core_int)
																	tmp52 := lang.Apply(tmp51, []any{int64(0)})
																	var v53 any = tmp52
																	_ = v53
																	for {
																		var tmp54 any
																		tmp55 := checkDerefVar(var_clojure_DOT_core__LT_)
																		tmp56 := lang.Apply(tmp55, []any{v53, v45})
																		if lang.IsTruthy(tmp56) {
																			var tmp57 any
																			{ // let
																				// let binding "row"
																				tmp58, _ := lang.FieldOrMethod(v40, "nth")
																				...
																				var v60 any = tmp59
																				_ = v60
																				tmp61 := checkDerefVar(var_clojure_DOT_core_chunk_DASH_append)
																				tmp62 := checkDerefVar(var_ys_DOT_v0_say)
																				tmp63 := checkDerefVar(var_ys_DOT_v0_joins)
																				tmp64 := checkDerefVar(var_ys_DOT_v0__PLUS_map)
																				tmp65 := lang.Apply(tmp64, []any{v60, v18})
																				tmp66 := lang.Apply(tmp63, []any{tmp65})
																				tmp67 := lang.Apply(tmp62, []any{tmp66})
																				tmp68 := lang.Apply(tmp61, []any{v48, tmp67})
																				_ = tmp68
																				tmp70 := checkDerefVar(var_clojure_DOT_core_unchecked_DASH_inc)
																				tmp71 := lang.Apply(tmp70, []any{v53})
																				var tmp69 any = tmp71
																				v53 = tmp69
																				continue
																			} // end let
																...
																if lang.IsTruthy(tmp50) {
																	tmp51 := checkDerefVar(var_clojure_DOT_core_chunk_DASH_cons)
																	tmp52 := checkDerefVar(var_clojure_DOT_core_chunk)
																	tmp53 := lang.Apply(tmp52, []any{v48})
																	tmp54 := checkDerefVar(var_clojure_DOT_core_chunk_DASH_rest)
																	tmp55 := lang.Apply(tmp54, []any{v33})
																	tmp56 := lang.Apply(v22, []any{tmp55})
																	tmp57 := lang.Apply(tmp51, []any{tmp53, tmp56})
																	tmp49 = tmp57
																} else {
																	tmp58 := checkDerefVar(var_clojure_DOT_core_chunk_DASH_cons)
																	tmp59 := checkDerefVar(var_clojure_DOT_core_chunk)
																	tmp60 := lang.Apply(tmp59, []any{v48})
																	tmp61 := lang.Apply(tmp58, []any{tmp60, nil})
																	tmp49 = tmp61
																}
																tmp37 = tmp49
															} // end let
															...
															{ // let
																// let binding "row"
																tmp39 := checkDerefVar(var_clojure_DOT_core_first)
																tmp40 := lang.Apply(tmp39, []any{v33})
																var v41 any = tmp40
																_ = v41
																tmp42 := checkDerefVar(var_clojure_DOT_core_cons)
																tmp43 := checkDerefVar(var_ys_DOT_v0_say)
																tmp44 := checkDerefVar(var_ys_DOT_v0_joins)
																tmp45 := checkDerefVar(var_ys_DOT_v0__PLUS_map)
																tmp46 := lang.Apply(tmp45, []any{v41, v18})
																tmp47 := lang.Apply(tmp44, []any{tmp46})
																tmp48 := lang.Apply(tmp43, []any{tmp47})
																tmp49 := checkDerefVar(var_clojure_DOT_core_rest)
																tmp50 := lang.Apply(tmp49, []any{v33})
																tmp51 := lang.Apply(v22, []any{tmp50})
																tmp52 := lang.Apply(tmp42, []any{tmp48, tmp51})
																tmp38 = tmp52
															} // end let
															tmp34 = tmp38
														}
								...
								tmp25 := lang.Apply(lang.NewLazySeq, []any{tmp24})
								return tmp25
							})
							v22 = tmp21
							_ = v22
				...
				return tmp3
			case 0:
				tmp2 := checkDerefVar(var_floyds_triangle_DOT_core_main)
				tmp3 := lang.Apply(tmp2, []any{int64(14)})
				return tmp3
			default:
				checkArity(args, -1)
				panic("unreachable")
		...
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var_floyds_triangle_DOT_core_main = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_floyds_triangle_DOT_core_main.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
}
