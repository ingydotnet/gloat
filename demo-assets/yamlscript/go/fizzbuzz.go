...
func init() {
	runtime.RegisterNSLoader("fizzbuzz/core", LoadNS)
}
...
// LoadNS initializes the namespace "fizzbuzz.core"
func LoadNS() {
	...
	sym_fizzbuzz_DOT_core := lang.NewSymbol("fizzbuzz.core")
	...
	// var fizzbuzz.core/-main
	var_fizzbuzz_DOT_core__DASH_main := lang.InternVarName(sym_fizzbuzz_DOT_core, sym__DASH_main)
	// var fizzbuzz.core/main
	var_fizzbuzz_DOT_core_main := lang.InternVarName(sym_fizzbuzz_DOT_core, sym_main)
	// var ys.std/truey?
	...
	_ = reflect.TypeOf
	ns := lang.FindOrCreateNamespace(sym_fizzbuzz_DOT_core)
	_ = ns
	...
	// -main
	{
		tmp0 := sym__DASH_main.WithMeta(lang.NewMap(kw_file, "fizzbuzz/core.glj", kw_line, int(17), kw_column, int(7), kw_end_DASH_line, int(17), kw_end_DASH_column, int(11), kw_arglists, lang.NewList(lang.NewVector(sym__AMP_, sym_argv)), kw_ns, lang.FindOrCreateNamespace(sym_fizzbuzz_DOT_core))).(*lang.Symbol)
		...
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			...
			default:
				...
				{ // let
					...
					tmp20 := lang.Apply(tmp19, []any{"/home/ingy/src/gloat/demo/yamlscript/fizzbuzz.ys"})
					...
					tmp28 := checkDerefVar(var_fizzbuzz_DOT_core_main)
		...
		var_fizzbuzz_DOT_core__DASH_main = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_fizzbuzz_DOT_core__DASH_main.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
	// main
	{
		tmp0 := sym_main.WithMeta(lang.NewMap(kw_file, "fizzbuzz/core.glj", kw_line, int(5), kw_column, int(7), kw_end_DASH_line, int(5), kw_end_DASH_column, int(10), kw_arglists, lang.NewList(lang.NewVector(sym_n), lang.NewVector()), kw_ns, lang.FindOrCreateNamespace(sym_fizzbuzz_DOT_core))).(*lang.Symbol)
		var tmp1 lang.FnFunc
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			switch len(args) {
			case 1:
				...
				{ // let
												...
												{ // let
													...
													if lang.IsTruthy(tmp20) {
																	...
																	if lang.IsTruthy(tmp40) {
																		...
																		{ // let
																			...
																			{ // let
																				...
																				tmp48 := checkDerefVar(var_ys_DOT_std_truey_QMARK_)
																				tmp49 := checkDerefVar(var_clojure_DOT_core_str)
																				var tmp50 any
																				{ // let
																					// let binding "and__0__auto__"
																					tmp51 := checkDerefVar(var_ys_DOT_std_truey_QMARK_)
																					tmp52 := checkDerefVar(var_ys_DOT_v0_falsey_QMARK_)
																					tmp53 := checkDerefVar(var_clojure_DOT_core_rem)
																					tmp54 := lang.Apply(tmp53, []any{v44, int64(3)})
																					...
																					if lang.IsTruthy(v57) {
																						tmp59 := checkDerefVar(var_ys_DOT_std_truey_QMARK_)
																						tmp60 := lang.Apply(tmp59, []any{"Fizz"})
																						tmp58 = tmp60
																					} else {
																						tmp58 = v57
																					}
																				...
																				{ // let
																					// let binding "and__0__auto__"
																					tmp52 := checkDerefVar(var_ys_DOT_std_truey_QMARK_)
																					tmp53 := checkDerefVar(var_ys_DOT_v0_falsey_QMARK_)
																					tmp54 := checkDerefVar(var_clojure_DOT_core_rem)
																					tmp55 := lang.Apply(tmp54, []any{v44, int64(5)})
																					...
																					if lang.IsTruthy(v58) {
																						tmp60 := checkDerefVar(var_ys_DOT_std_truey_QMARK_)
																						tmp61 := lang.Apply(tmp60, []any{"Buzz"})
																						tmp59 = tmp61
																					} else {
																						tmp59 = v58
																					}
																				...
																				tmp52 := lang.Apply(tmp49, []any{tmp50, tmp51})
																				...
																				if lang.IsTruthy(v54) {
																					...
																					tmp56 := checkDerefVar(var_ys_DOT_std_truey_QMARK_)
																					tmp57 := lang.Apply(tmp56, []any{v44})
																					tmp55 = tmp57
																				}
																				tmp47 = tmp55
																			} // end let
																			tmp48 := lang.Apply(tmp46, []any{tmp47})
																			tmp49 := lang.Apply(tmp45, []any{v32, tmp48})
																			_ = tmp49
																			tmp51 := checkDerefVar(var_clojure_DOT_core_unchecked_DASH_inc)
														...
														{ // let
															...
															{ // let
																// let binding "or__0__auto__"
																tmp29 := checkDerefVar(var_ys_DOT_std_truey_QMARK_)
																tmp30 := checkDerefVar(var_clojure_DOT_core_str)
																var tmp31 any
																{ // let
																	// let binding "and__0__auto__"
																	tmp32 := checkDerefVar(var_ys_DOT_std_truey_QMARK_)
																	tmp33 := checkDerefVar(var_ys_DOT_v0_falsey_QMARK_)
																	tmp34 := checkDerefVar(var_clojure_DOT_core_rem)
																	tmp35 := lang.Apply(tmp34, []any{v25, int64(3)})
																	...
																	if lang.IsTruthy(v38) {
																		tmp40 := checkDerefVar(var_ys_DOT_std_truey_QMARK_)
																		tmp41 := lang.Apply(tmp40, []any{"Fizz"})
																		tmp39 = tmp41
																	} else {
																		tmp39 = v38
																	}
																...
																{ // let
																	// let binding "and__0__auto__"
																	tmp33 := checkDerefVar(var_ys_DOT_std_truey_QMARK_)
																	tmp34 := checkDerefVar(var_ys_DOT_v0_falsey_QMARK_)
																	tmp35 := checkDerefVar(var_clojure_DOT_core_rem)
																	tmp36 := lang.Apply(tmp35, []any{v25, int64(5)})
																	...
																	if lang.IsTruthy(v39) {
																		tmp41 := checkDerefVar(var_ys_DOT_std_truey_QMARK_)
																		tmp42 := lang.Apply(tmp41, []any{"Buzz"})
																		tmp40 = tmp42
																	} else {
																		tmp40 = v39
																	}
																...
																tmp33 := lang.Apply(tmp30, []any{tmp31, tmp32})
																...
																if lang.IsTruthy(v35) {
																	...
																	tmp37 := checkDerefVar(var_ys_DOT_std_truey_QMARK_)
																	tmp38 := lang.Apply(tmp37, []any{v25})
																	tmp36 = tmp38
																}
																tmp28 = tmp36
															} // end let
															tmp29 := lang.Apply(tmp27, []any{tmp28})
															tmp30 := checkDerefVar(var_clojure_DOT_core_rest)
															tmp31 := lang.Apply(tmp30, []any{v17})
															tmp32 := lang.Apply(v6, []any{tmp31})
															tmp33 := lang.Apply(tmp26, []any{tmp29, tmp32})
															tmp22 = tmp33
														} // end let
														tmp18 = tmp22
													}
					...
					tmp8 := lang.Apply(tmp7, []any{int64(1), v2})
				...
				return tmp5
			case 0:
				tmp2 := checkDerefVar(var_fizzbuzz_DOT_core_main)
				tmp3 := lang.Apply(tmp2, []any{int64(100)})
				return tmp3
			default:
				checkArity(args, -1)
				panic("unreachable")
		...
		tmp1 = tmp1.WithMeta(lang.NewMap(kw_rettag, nil)).(lang.FnFunc)
		var_fizzbuzz_DOT_core_main = ns.InternWithValue(tmp0, tmp1, true)
		if tmp0.Meta() != nil {
			var_fizzbuzz_DOT_core_main.SetMeta(tmp0.Meta().(lang.IPersistentMap))
		}
	}
}
